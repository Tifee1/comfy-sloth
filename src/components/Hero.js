    ...
    <Wrapper className='section-center'>
      <article className='content'>
        ...
        <p>
          ...
          fuga perspiciatis ea. Reprehenderit, quas laudantium molestias nobis
          harum iste blanditiis alias similique quia recusandae dolorem tempore
          laborum.
        </p>
      ...
      <article className='img-container'>
        ...
        <img src={hero2} alt='hero2' className='accent-img' />
      </article>
    </Wrapper>
  )
}
